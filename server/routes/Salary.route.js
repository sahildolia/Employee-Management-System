...
import { HandleCreateSalary, HandleAllSalary, HandleSalary, HandleMySalary, HandleUpdateSalary, HandleDeleteSalary } from '../controllers/Salary.controller.js'
...
router.get("/my-salaries", VerifyEmployeeToken, HandleMySalary)
